  ...
  return (
    <div className="space-y-8">
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-900 via-green-950/50 to-gray-900 border border-border/30">
        <div className="relative px-6 py-10 sm:px-10 sm:py-14">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-white">Careers at WCCG</h1>
              <p className="text-white/50 mt-1">Join the team behind Fayetteville&apos;s Hip Hop Station</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="rounded-xl border border-white/[0.06] bg-[#141420] p-6 sm:p-8 space-y-4">
        <h2 className="text-xl font-semibold text-white">Why WCCG?</h2>
      ...
      <div className="rounded-xl border border-white/[0.06] bg-[#141420] p-6 sm:p-8">
        <h2 className="text-xl font-semibold text-white mb-4">Apply Now</h2>
        {submitted ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div>
                <label className="block text-sm text-white/60 mb-1">Position Interest</label>
                <select
                ...
                >
                  <option value="" className="bg-[#141420]">Select area of interest</option>
                  <option value="on-air" className="bg-[#141420]">On-Air Talent</option>
                  <option value="production" className="bg-[#141420]">Production</option>
                  <option value="sales" className="bg-[#141420]">Sales & Advertising</option>
                  <option value="engineering" className="bg-[#141420]">Engineering / Technical</option>
                  <option value="digital" className="bg-[#141420]">Digital / Web / Social</option>
                  <option value="events" className="bg-[#141420]">Events & Promotions</option>
                  <option value="admin" className="bg-[#141420]">Administrative</option>
                  <option value="other" className="bg-[#141420]">Other</option>
                </select>
              </div>
            </div>
            <div>
              <label className="block text-sm text-white/60 mb-1">Tell us about yourself</label>
              <textarea
                rows={4}
      ...
      <div className="rounded-xl border border-white/[0.06] bg-[#141420] p-6 space-y-2">
