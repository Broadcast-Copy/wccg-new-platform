          ...
          <div className="mt-6 border-t border-border pt-6">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                {/* Spotify icon intentionally omitted until a verified WCCG
                    profile URL exists — the old icon linked to the generic
                    open.spotify.com homepage. Add the real URL to
                    STATION_SOCIAL in data/schedule.ts and reference it here. */}
              </div>
            </div>
          </div>
        </div>
