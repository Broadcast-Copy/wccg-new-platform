    ...
    <div className="flex min-h-screen flex-col bg-[#0a0a0f]">
      ...
      <footer className="border-t border-white/[0.06] bg-[#07070c] pb-28">
        <div className="container py-10">
          ...
          <div className="mt-8 rounded-xl border border-white/[0.06] bg-white/[0.03] p-5 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-bold text-white">Carson Communications</p>
                <p className="text-xs text-white/40">Your Trusted Partner In Advertising</p>
              </div>
            </div>
            <Link
              href="/advertise"
              className="inline-flex items-center gap-1.5 rounded-full border border-white/20 px-4 py-1.5 text-xs font-semibold text-white/70 hover:bg-white/[0.06] hover:text-white transition-colors"
            >
              Get Started
            </Link>
          </div>
          ...
          <div className="mt-6 border-t border-white/[0.06] pt-6">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-3">
                {/* Facebook */}
                <a href="https://facebook.com/wccg1045fm" target="_blank" rel="noopener noreferrer" className="flex h-8 w-8 items-center justify-center rounded-full bg-white/[0.06] text-white/30 hover:text-white/70 hover:bg-white/[0.1] transition-colors" aria-label="Facebook">
                ...
                {/* X / Twitter */}
                <a href="https://x.com/wccg1045fm" target="_blank" rel="noopener noreferrer" className="flex h-8 w-8 items-center justify-center rounded-full bg-white/[0.06] text-white/30 hover:text-white/70 hover:bg-white/[0.1] transition-colors" aria-label="X">
                  <svg className="h-3.5 w-3.5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                </a>
                {/* Instagram */}
                <a href="https://instagram.com/wccg1045fm" target="_blank" rel="noopener noreferrer" className="flex h-8 w-8 items-center justify-center rounded-full bg-white/[0.06] text-white/30 hover:text-white/70 hover:bg-white/[0.1] transition-colors" aria-label="Instagram">
                ...
                {/* YouTube */}
                <a href="https://youtube.com/@wccg1045fm" target="_blank" rel="noopener noreferrer" className="flex h-8 w-8 items-center justify-center rounded-full bg-white/[0.06] text-white/30 hover:text-white/70 hover:bg-white/[0.1] transition-colors" aria-label="YouTube">
                ...
                {/* TikTok */}
                <a href="https://tiktok.com/@wccg1045fm" target="_blank" rel="noopener noreferrer" className="flex h-8 w-8 items-center justify-center rounded-full bg-white/[0.06] text-white/30 hover:text-white/70 hover:bg-white/[0.1] transition-colors" aria-label="TikTok">
                ...
                {/* LinkedIn */}
                <a href="https://linkedin.com/company/wccg1045fm" target="_blank" rel="noopener noreferrer" className="flex h-8 w-8 items-center justify-center rounded-full bg-white/[0.06] text-white/30 hover:text-white/70 hover:bg-white/[0.1] transition-colors" aria-label="LinkedIn">
                ...
                {/* Twitch */}
                <a href="https://twitch.tv/wccg1045fm" target="_blank" rel="noopener noreferrer" className="flex h-8 w-8 items-center justify-center rounded-full bg-white/[0.06] text-white/30 hover:text-white/70 hover:bg-white/[0.1] transition-colors" aria-label="Twitch">
                ...
                {/* Discord */}
                <a href="https://discord.gg/wccg1045fm" target="_blank" rel="noopener noreferrer" className="flex h-8 w-8 items-center justify-center rounded-full bg-white/[0.06] text-white/30 hover:text-white/70 hover:bg-white/[0.1] transition-colors" aria-label="Discord">
                ...
                {/* Spotify */}
                <a href="https://open.spotify.com" target="_blank" rel="noopener noreferrer" className="flex h-8 w-8 items-center justify-center rounded-full bg-white/[0.06] text-white/30 hover:text-white/70 hover:bg-white/[0.1] transition-colors" aria-label="Spotify">
