  ...
  return (
    <div className="space-y-8">
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-900 via-blue-950/50 to-gray-900 border border-border/30">
        <div className="relative px-6 py-10 sm:px-10 sm:py-14">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-foreground">Equal Employment Opportunity</h1>
              <p className="text-muted-foreground mt-1">Our commitment to equal opportunity employment</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="rounded-xl border border-border bg-card p-6 sm:p-8 space-y-4">
        <h2 className="text-xl font-semibold text-foreground">EEO Policy Statement</h2>
      ...
      <div className="rounded-xl border border-border bg-card p-6 sm:p-8 space-y-4">
        <h2 className="text-xl font-semibold text-foreground">EEO Public File Report</h2>
        <p className="text-muted-foreground leading-relaxed">
      ...
      <div className="rounded-xl border border-border bg-card p-6 sm:p-8 space-y-4">
        <h2 className="text-xl font-semibold text-foreground">View Our EEO Reports</h2>
