    ...
    return (
      <HubSidebar hubType="listener" color="#14b8a6">
        <div className="space-y-6">
          {/* Warm welcome banner */}
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#74ddc7] via-[#2dd4bf] to-[#14b8a6]">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-900/70">
                    Welcome back to the Listener Hub — see what the community is playing.
                  </p>
                </div>
              </div>
              <button
            ...
            {[
              ...
              >
                <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-[#14b8a6]/10">
                  <s.icon className="h-4 w-4 text-[#14b8a6]" />
                </div>
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <HubRail hubType="listener" accentColor="#14b8a6" supabase={supabase} />
          </div>
        </div>
      </HubSidebar>
    );
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-900/60 mt-1">
                    A network for listeners â€” connect, discover, and earn rewards
                  </p>
                </div>
              </div>
              {user && (
