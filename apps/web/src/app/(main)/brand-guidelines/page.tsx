...
const brandColors = [
  ...
  { name: "WCCG Purple", hex: "#7401df", textColor: "text-white" },
  { name: "WCCG Red", hex: "#dc2626", textColor: "text-white" },
  { name: "Background Dark", hex: "#0a0a0f", textColor: "text-white" },
  { name: "Card Dark", hex: "#141420", textColor: "text-white" },
  ...
  return (
    <div className="space-y-8">
        ...
        <div className="relative px-6 py-10 sm:px-10 sm:py-14">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-white/50 mt-1">Official WCCG 104.5 FM brand identity and usage rules</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="rounded-xl border border-white/[0.06] bg-[#141420] p-6 sm:p-8 space-y-4">
        <h2 className="text-xl font-semibold text-white">About Our Brand</h2>
      ...
      <div className="space-y-4">
        ...
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
          {brandColors.map((color) => (
            <div key={color.hex} className="rounded-xl border border-white/[0.06] overflow-hidden">
              <div
      ...
      {/* Channel Gradients */}
      <div className="space-y-4">
        <h2 className="text-xl font-semibold text-white">Channel Brand Colors</h2>
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
          {channels.map((ch) => (
            <div
              key={ch.name}
      ...
      {/* Logo Usage */}
      <div className="rounded-xl border border-white/[0.06] bg-[#141420] p-6 sm:p-8 space-y-4">
        <h2 className="text-xl font-semibold text-white">Logo Usage</h2>
        <div className="space-y-3 text-sm text-white/50">
          <p><strong className="text-white">Clear Space:</strong> Maintain a minimum clear space around the logo equal to the height of the &ldquo;104.5&rdquo; text.</p>
          <p><strong className="text-white">Minimum Size:</strong> The logo should never appear smaller than 80px wide in digital or 1 inch wide in print.</p>
          <p><strong className="text-white">Backgrounds:</strong> Use the full-color logo on dark backgrounds. Use the black version on light backgrounds.</p>
          <p><strong className="text-white">Do Not:</strong> Stretch, rotate, recolor, add effects, or alter the logo in any way.</p>
        </div>
      </div>
      ...
      <div className="rounded-xl border border-white/[0.06] bg-[#141420] p-6 sm:p-8 space-y-4">
        ...
        <div className="space-y-3 text-sm text-white/50">
          <p><strong className="text-white">Primary Font:</strong> Geist Sans — used for headings and body text across digital platforms.</p>
          <p><strong className="text-white">Monospace:</strong> Geist Mono — used for technical content and data displays.</p>
          <p><strong className="text-white">Fallback:</strong> system-ui, -apple-system, sans-serif</p>
        </div>
      </div>
