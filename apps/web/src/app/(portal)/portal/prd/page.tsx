    ...
    modules: [
      ...
      },
      {
        ...
        features: [
          ...
          { name: "Live Monitoring Dashboard", description: "Real-time listener counts, bitrate status, and uptime metrics for all 6 channels with auto-alerts", priority: "critical", status: "in-progress", icon: Activity },
          ...
          { name: "Centova Cast API", description: "Full integration with Centova Cast for DJ accounts, auto-DJ, request system, and statistics", priority: "high", status: "in-progress", icon: Settings },
      ...
      },
      {
        ...
        color: "#7401df",
        features: [
          { name: "Content Approval Queue", description: "Review pending mixes, podcast episodes, events, and directory claims before publication", priority: "critical", status: "in-progress", icon: FileText },
      ...
      },
      {
        ...
        color: "#3b82f6",
        features: [
          { name: "Real-Time Dashboard", description: "Live metrics: active listeners, concurrent streams, peak hours, geographic heatmap", priority: "critical", status: "in-progress", icon: Activity },
      ...
      },
      {
        ...
        features: [
          ...
          { name: "Audit Logs", description: "Comprehensive activity log for all admin actions with timestamps, IP addresses, and user agents", priority: "high", status: "planned", icon: FileText },
        ],
      },
    ],
  },
    ...
    modules: [
      {
        ...
        color: "#f97316",
        features: [
          { name: "Client Profiles", description: "Full business profiles with contact info, billing history, contract terms, and notes", priority: "critical", status: "planned", icon: Users },
          { name: "Lead Pipeline", description: "Track prospects through stages: lead, contacted, proposal sent, negotiating, closed-won/lost", priority: "high", status: "planned", icon: Target },
      ...
      },
      {
        ...
        color: "#74ddc7",
        features: [
          { name: "Campaign Builder", description: "Create campaigns with date ranges, budget, target demographics, daypart selection, and frequency caps", priority: "critical", status: "planned", icon: Target },
          { name: "Ad Scheduling", description: "Schedule ad spots across live streams, podcasts, and pre-roll. Calendar view with conflict detection", priority: "critical", status: "planned", icon: CalendarDays },
      ...
      },
      {
        ...
        color: "#7401df",
        features: [
          { name: "Proposal Generator", description: "Create branded PDF proposals with rate cards, audience demographics, reach estimates, and package options", priority: "high", status: "planned", icon: FileText },
          ...
          { name: "Rate Card Management", description: "Maintain rate cards with pricing tiers for 15s/30s/60s spots, sponsorships, and digital ads", priority: "high", status: "planned", icon: DollarSign },
      ...
      },
      {
        ...
        color: "#3b82f6",
        features: [
          { name: "Revenue Dashboard", description: "Real-time revenue metrics: MTD, QTD, YTD with comparisons to prior periods and targets", priority: "critical", status: "planned", icon: DollarSign },
          ...
          { name: "Advertiser Reports", description: "Generate per-client performance reports with impressions, plays, reach, and ROI estimates", priority: "high", status: "planned", icon: BarChart3 },
        ],
      },
    ],
  },
    ...
    modules: [
      {
        ...
        color: "#ef4444",
        features: [
          { name: "Self-Service Campaign Builder", description: "Step-by-step wizard: select ad type (audio/banner/sponsorship), set dates, budget, target audience, and dayparts", priority: "critical", status: "planned", icon: Target },
          { name: "Campaign Dashboard", description: "View all active, paused, and completed campaigns with key metrics at a glance", priority: "critical", status: "planned", icon: BarChart3 },
          { name: "Budget & Pacing", description: "Set daily/total budgets. Real-time pacing indicators showing spend vs budget with projections", priority: "high", status: "planned", icon: DollarSign },
          ...
          { name: "Campaign Pause/Resume", description: "Instantly pause or resume campaigns with one click. Automatic pause on budget exhaustion", priority: "medium", status: "planned", icon: Play },
        ],
      },
      {
        name: "Ad Creative",
        ...
        color: "#7401df",
        features: [
          { name: "Creative Upload", description: "Upload audio spots (15s/30s/60s), display banners (multiple sizes), and sponsorship copy", priority: "critical", status: "planned", icon: Upload },
          { name: "Creative Library", description: "Organized library of all uploaded creatives with version history, approval status, and usage tracking", priority: "high", status: "planned", icon: Image },
          { name: "Creative Specs Guide", description: "Interactive specs page showing required formats, dimensions, file sizes, and audio loudness standards", priority: "medium", status: "planned", icon: FileText },
          { name: "Creative Approval Status", description: "Track approval workflow: submitted, in-review, approved, rejected (with feedback)", priority: "high", status: "planned", icon: CheckCircle2 },
        ],
      },
      {
        ...
        color: "#3b82f6",
        features: [
          { name: "Impressions & Reach", description: "Track total impressions, unique reach, frequency per listener, and geographic distribution", priority: "critical", status: "planned", icon: Eye },
          { name: "Click-Through Analytics", description: "CTR by creative, placement, daypart, and audience segment. Heatmaps for banner ads", priority: "high", status: "planned", icon: MousePointerClick },
          ...
          { name: "Automated Reports", description: "Schedule weekly/monthly performance reports delivered via email as PDF attachments", priority: "medium", status: "planned", icon: FileText },
        ],
      },
      {
        ...
        color: "#f97316",
        features: [
          { name: "Invoice History", description: "View and download all invoices with line-item detail by campaign. PDF export", priority: "critical", status: "planned", icon: FileText },
          { name: "Payment Methods", description: "Add/remove credit cards and ACH accounts. Auto-pay configuration for recurring campaigns", priority: "high", status: "planned", icon: CreditCard },
          { name: "Spending Alerts", description: "Set email alerts for daily/weekly spend thresholds. Prevent overspend with hard caps", priority: "medium", status: "planned", icon: Bell },
    ...
    modules: [
      {
        ...
        features: [
          ...
          { name: "Earning Actions", description: "Earn points for: listening (1pt/min), event check-ins (50pts), social shares (25pts), referrals (100pts), contests (varies)", priority: "critical", status: "in-progress", icon: Zap },
      ...
      },
      {
        ...
        features: [
          ...
          { name: "Ticket Purchase/RSVP", description: "Register for free events or purchase tickets. QR code tickets with digital wallet support", priority: "critical", status: "in-progress", icon: Ticket },
      ...
      },
      {
        ...
        features: [
          ...
          { name: "Follow DJs/Creators", description: "Follow creators to see their new content in your feed. Notification preferences per creator", priority: "high", status: "planned", icon: Users },
          { name: "Listening History", description: "Auto-tracked history of streams, mixes, and podcasts listened to. Resume where you left off", priority: "medium", status: "planned", icon: Clock },
