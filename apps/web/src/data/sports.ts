...
export const DUKE_BASKETBALL: SportsTeam = {
  ...
  heroImageUrl: "/images/sports/dukebasketball.jpg",
  ...
  stats: [
    ...
    { label: "2025-26 Record", value: "Season Complete" },
  ...
  // Offseason — no upcoming game. ESPN overlay will populate when schedule resumes.
  nextGame: undefined,
  schedule: [],
  lastGame: {
    opponent: "St. John's Red Storm",
    opponentLogo: "https://a.espncdn.com/i/teamlogos/ncaa/500/2599.png",
    date: "2026-03-27T23:10:00-04:00",
    result: "W",
    score: { duke: 76, opponent: 63 },
    venue: "Capital One Arena, Washington, DC",
    topPerformer: { name: "Cameron Boozer", points: 24, rebounds: 11, assists: 4 },
  },
};
...
export const DUKE_FOOTBALL: SportsTeam = {
  ...
  heroImageUrl: "/images/sports/FOOTBALL-DUKE.png",
  ...
  gradient: "from-[#003087] via-[#001a4d] to-[#0a0a0f]",
  // Season schedule mirrors ESPN (teams/150/schedule) as of 2026-09-05.
  // Live pages read ESPN directly; this is the offline/fallback copy.
  nextGame: {
    espnEventId: "401858209",
    opponent: "Tulane Green Wave",
    opponentLogo: "https://a.espncdn.com/i/teamlogos/ncaa/500/2655.png",
  ...
  schedule: [
    ...
    {
      espnEventId: "401858217",
      opponent: "Illinois Fighting Illini",
      opponentLogo: "https://a.espncdn.com/i/teamlogos/ncaa/500/356.png",
      date: "2026-09-12T15:30:00-04:00",
      time: "3:30 PM ET",
      venue: "Gies Memorial Stadium",
      isHome: false,
      broadcast: "FS1 / WCCG 104.5 FM",
    },
    {
      espnEventId: "401858231",
      ...
      venue: "Wallace Wade Stadium",
      isHome: true,
      broadcast: "CW / WCCG 104.5 FM",
    },
    {
      espnEventId: "401858244",
      opponent: "William & Mary Tribe",
      opponentLogo: "https://a.espncdn.com/i/teamlogos/ncaa/500/2729.png",
      date: "2026-09-26T15:30:00-04:00",
      time: "3:30 PM ET",
      venue: "Wallace Wade Stadium",
      isHome: true,
      broadcast: "ACCNX / WCCG 104.5 FM",
    },
    {
      espnEventId: "401858255",
      opponent: "Georgia Tech Yellow Jackets",
      opponentLogo: "https://a.espncdn.com/i/teamlogos/ncaa/500/59.png",
      date: "2026-10-10T00:00:00-04:00",
      time: "TBA",
      venue: "Bobby Dodd Stadium",
      isHome: false,
      broadcast: "WCCG 104.5 FM",
    },
    {
      espnEventId: "401858266",
      opponent: "North Carolina Tar Heels",
      opponentLogo: "https://a.espncdn.com/i/teamlogos/ncaa/500/153.png",
      date: "2026-10-17T00:00:00-04:00",
      time: "TBA",
      venue: "Wallace Wade Stadium",
      isHome: true,
      broadcast: "WCCG 104.5 FM",
    ...
    {
      espnEventId: "401858279",
      opponent: "Boston College Eagles",
      opponentLogo: "https://a.espncdn.com/i/teamlogos/ncaa/500/103.png",
      date: "2026-10-31T00:00:00-04:00",
      time: "TBA",
      venue: "Wallace Wade Stadium",
      isHome: true,
      broadcast: "WCCG 104.5 FM",
