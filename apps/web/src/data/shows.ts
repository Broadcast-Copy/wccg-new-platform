...
export const SHOW_STREETZ_MORNING: ShowData = {
  ...
  hostImageUrl: "/images/hosts/streetz-hosts.png",
...
export const SHOW_WAY_UP_ANGELA_YEE: ShowData = {
  ...
  showImageUrl: "/images/shows/way-up-angela-yee.png",
  hostImageUrl: "/images/hosts/angela-yee-host.webp",
  youtube: {
...
export const SHOW_BOOTLEG_KEV: ShowData = {
  ...
  imageUrl: "/images/shows/bootleg-kev-show.png",
  showImageUrl: "/images/shows/bootleg-kev-show.png",
  hostImageUrl: "/images/hosts/bootleg-kev-host.jpg",
  youtube: {
...
export const SHOW_PRAISE_MIX: ShowData = {
  ...
  imageUrl: null,
  showImageUrl: "/images/shows/praise-mix-6.png",
  isSyndicated: false,
  isActive: true,
  category: "gospel",
};
...
export const SHOW_GRACE_PLUS_NOTHING: ShowData = {
  ...
  imageUrl: null,
  showImageUrl: "/images/shows/grace-plus-nothing.png",
  youtube: {
...
export const SHOW_ENCOURAGING_MOMENT: ShowData = {
  ...
  imageUrl: null,
  showImageUrl: "/images/shows/encouraging-moments.png",
  youtube: {
...
export const SHOW_MARVIN_SAPP: ShowData = {
  ...
  gradient: "from-[#1a0533] via-[#2d1b69] to-[#1a1a2e]",
  imageUrl: null,
  showImageUrl: "/images/shows/marvin-sapp-show.jpg",
  isSyndicated: true,
  isActive: true,
  category: "gospel",
};
...
export const SHOW_FAMILY_FELLOWSHIP: ShowData = {
  ...
  imageUrl: null,
  showImageUrl: "/images/shows/family-fellowship.png",
  youtube: {
...
export const SHOW_PROGRESSIVE_MBC: ShowData = {
  ...
  imageUrl: null,
  showImageUrl: "/images/shows/progressive-baptist.png",
  youtube: {
...
export const SHOW_LEWIS_CHAPEL: ShowData = {
  ...
  gradient: "from-[#1a1a2e] via-[#16213e] to-[#0d1b2a]",
  imageUrl: null,
  showImageUrl: "/images/shows/lewis-chapel.png",
  youtube: {
...
export const SHOW_GOGO_MIX: ShowData = {
  ...
  imageUrl: "/images/shows/crank-corleone.png",
  showImageUrl: "/images/shows/crank-corleone.png",
  hostImageUrl: "/images/hosts/shorty-corleone.png",
  isSyndicated: false,
  isActive: true,
  category: "sunday",
};
...
export const SHOW_MIXSQUAD_RADIO: ShowData = {
  ...
  slug: "mixsquad-radio",
  hostNames: "DJ Ricovelli, DJ SpinWiz, DJ Rayn, DJ TommyGeeMixx & DJ Yodo",
  hostIds: ["host_dj_ricovelli", "host_dj_spinwiz", "host_dj_rayn", "host_dj_tommygee", "host_dj_yodo"],
  timeSlot: "24/7",
  days: "Every Day",
  streamId: "stream_mixsquad",
  description: "MixxSquadd Radio delivers non-stop DJ mixes 24/7 on its own dedicated stream. Featuring DJ Ricovelli, DJ SpinWiz, DJ Rayn, DJ TommyGeeMixx, and DJ Yodo with the best in hip hop, R&B, dancehall, and club mixes.",
...
export const SHOW_ISLAND_FREQUENCY: ShowData = {
  ...
  imageUrl: "/images/shows/island-frequency.jpg",
  showImageUrl: "/images/shows/island-frequency.jpg",
  hostImageUrl: "/images/hosts/dj-daffie.png",
  isSyndicated: false,
  isActive: true,
  category: "sunday",
};
